...
const GMLIB_API = {
    ...
    addFakeList: ll.imports("GMLib_ServerAPI", "addFakeList"),
    /** 删除虚假列表玩家 @type {function(string):boolean} */
    removeFakeList: ll.imports("GMLib_ServerAPI", "removeFakeList"),
    /** 删除所有虚假列表玩家 @type {function():void} */
    removeAllFakeLists: ll.imports("GMLib_ServerAPI", "removeAllFakeList"),
