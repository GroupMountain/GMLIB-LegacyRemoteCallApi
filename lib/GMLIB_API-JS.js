...
class data {
    ...
    static getXuidByUuid(uuid){
        return GMLIB_API.getXuidByUuid(uuid);
    }
    
    static getUuidByXuid(xuid){
        return GMLIB_API.getUuidByXuid(xuid);
    }

    static getNameByUuid(uuid){
        return GMLIB_API.getNameByUuid(uuid);
    }

    static getNameByXuid(xuid){
        return GMLIB_API.getNameByXuid(xuid);
    }

    static getXuidByName(name){
        return GMLIB_API.getXuidByName(name);
    }
