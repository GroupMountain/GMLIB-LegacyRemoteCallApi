...
class StaticFloatingText {
    constructor(pos, text) {
        this.mPosition = pos;
        this.mText = text;
        this.mRuntimeId = GMLIB_API.createFloatingText(this.mPosition, this.mText);
...
class DynamicFloatingText extends StaticFloatingText {
    constructor(pos, text, updateRate = 1) {
        super(pos, text);
...
export { StaticFloatingText, DynamicFloatingText, Minecraft, Recipes, Experiments };